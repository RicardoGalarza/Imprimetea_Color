...
<html lang="en">
    <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="<?php echo base_url() ?>assets-template/assets/images/favicon.ico">
        ...
        <!-- App Css-->
        <link href="<?php echo base_url() ?>assets-template/assets/css/app.min.css" id="app-stylesheet" rel="stylesheet" type="text/css" />
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="text-center">
                            <a href="index.html" class="logo">
                                <img src="<?php echo base_url() ?>assets-template/assets/images/logo-light.png" alt="" height="22" class="logo-light mx-auto">
                               <img src="<?php echo base_url() ?>assets-template/assets/images/logo-dark.png" alt="" height="22" class="logo-dark mx-auto">
                            </a>
